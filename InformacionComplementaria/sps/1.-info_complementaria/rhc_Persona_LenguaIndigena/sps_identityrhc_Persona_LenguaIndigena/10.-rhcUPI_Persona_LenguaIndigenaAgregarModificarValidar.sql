...
BEGIN
    ...
    BEGIN
        SET @noError = 1
        SET @mensaje = N'El campo apellido paterno no puede quedar vacío, favor de verificar'
        RETURN
    END
    ...
    BEGIN
        SET @noError = 1
        SET @mensaje = N'El campo apellido materno no puede quedar vacío, favor de verificar'
        RETURN
    END
    ...
    BEGIN
        SET @noError = 1
        SET @mensaje = N'El campo nombres no puede quedar vacío, favor de verificar'
        RETURN
    END
    ...
    BEGIN
        SET @noError = 1
        SET @mensaje = N'El campo adscripción no puede quedar vacío, favor de verificar'
        RETURN
    END
    ...
    BEGIN
        SET @noError = 1
        SET @mensaje = N'Esta persona ya existe, verifique el tipo de parentesco y el nombre'
        RETURN
    END
